...
function buscarMedidasEmTempoReal(idMaquina) {
    ...
    if (process.env.AMBIENTE_PROCESSO == "producao") {
        instrucaoSql = `select top 1 l.nivelRam, l.nivelCPU, l.discoDisponivel, FORMAT(l.dataHora, 'HH:mm') as momento_grafico from [dbo].[logDesempenho] as l where fkMaquina = ${idMaquina} ORDER BY momento_grafico DESC;`;
